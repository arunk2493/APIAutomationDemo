let fetch,describe,it;_acc‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);_acc‍.w("mocha",[["describe",["describe"],function(v){describe=v}],["it",["it"],function(v){it=v}]]);
